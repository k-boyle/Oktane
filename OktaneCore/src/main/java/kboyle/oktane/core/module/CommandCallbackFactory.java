...
class CommandCallbackFactory {
    ...
    private static final String CLASS_TEMPLATE = """
        ...
        public final class %2$s implements %11$s {
            ...
            @Override
            public %21$s%4$s execute(%5$s context, Object[] beans, Object[] parameters) {
                %8$s
                %7$s
    ...
    public <T extends CommandContext> CommandCallback createCommandCallback(
        ...
        Class<ExecutionErrorResult> exceptionResultClazz = ExecutionErrorResult.class;
        String executionErrorResultSimpleName = exceptionResultClazz.getSimpleName();
        String executionErrorResultPackage = exceptionResultClazz.getPackageName();
        ...
        String code = String.format(
            ...
            package0,
            generatedClassName,
            executionErrorResultSimpleName,
